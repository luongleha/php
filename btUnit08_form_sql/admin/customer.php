	...
	<div style="width: 95%; margin: 0 auto;">
				...
				foreach ($customers as $customer) {
					...
					<tr id="<?php echo $customer['id']; ?>">
						...
						<td>
							...
							<a href="quanlikhachhang/customer_delete.php?id=<?php echo $customer['id']; ?>" class = "btn btn-danger btn-delete" data-id="<?php echo $customer['id']; ?>">Delete</a>
						</td>
		...
		<script type="text/javascript">
			...
			$('.btn-detail').on('click',function() {
				...
				$.ajax({
					type: 'get',
					url: 'quanlikhachhang/customer_detail.php?id='+id,
					dataType:'json',
