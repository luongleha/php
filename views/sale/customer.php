				...
				foreach ($customers as $key => $customer) {
					...
					<tr>
						...
						<td>
							...
							<a href="?mod=sale&act=purchase&id=<?= $customer['id'] ?>"" class = "btn btn-primary "><i class="fa fa-cart-plus" aria-hidden="true"></i> Tạo hóa đơn</a>
						</td>
						<!-- Modal -->
			...
			$('.btn-detail').on('click',function() {
				...
				$.ajax({
					...
					success : function(customer){
						...
						$('#customer_image').attr('src','public/images/'+ customer.image)
					}
				})
			});
		</script>
