...
<div class="container" style="margin-left: 206px;">
    <form action="?mod=product&act=update&id=<?= $product['id'] ?>" method="POST" role="form" enctype="multipart/form-data">
        <h2 align="center">Cập nhật Sản Phẩm</h2>          
        <div class="form-group">
            <label for=""><b>Tên sản phẩm</b></label>
            <input type="hidden" id="" name="id" value = "<?= $product['id'] ?>">
            <input type="text" class="form-control" id="" placeholder="Nhập tên sản phẩm" name="name" required="" value="<?= $product['name'] ?>">
        </div> 
        <div class="form-group">
            <label for=""><b>Số lượng</b></label>
            <input type="text" class="form-control" id="" placeholder="Nhập vào số lượng" name="quantity" required="" value="<?= $product['quantity'] ?>">
        </div>   
        <div class="form-group">
            <label for=""><b>Đơn giá</b></label>
            <input type="text" class="form-control" id="" placeholder="Nhập vào giá sản phẩm" name="price" required="" value="<?= $product['price'] ?>">
        </div>  
        <div class="form-group">
            ...
            <img src="public/images/<?= $product['image'] ?>" id="output" alt="" width = "100px" height = "100px">
            <script>
